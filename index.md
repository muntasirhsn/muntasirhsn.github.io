...
* Many countries (e.g. China, India) and regions show a clear upward trend in carbon dioxide emissions from 1960 to 2024. For instance, emission from China increased from 909 Mt CO₂e in 1970 to over 13000 Mt CO₂e in 2023, although the population increased from ~0.8 billion to only ~1.4 billion, reflecting rapid industrialization. While the population of China and India in 2023 were nearly the same, the CO₂ emission from China was 4.5 fold to that of India. 
