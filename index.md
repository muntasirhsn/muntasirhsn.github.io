...
### MLOps with AWS: Preprocess data, train models at scale, deploy to production and monitor models with data pipeline automation
...
### Predictive modelling: End-to-end machine learning pipeline
Here, I built a comprehensive end-to-end machine learning pipeline that efficiently handles data preprocessing, model training, and prediction on test/inference data. The pipeline automates the workflow from data ingestion and feature engineering to model deployment, ensuring robust and scalable machine learning solutions. 

<img src="images/Saleprice3.png?raw=true"/> Figure: Relation between numerical features and the target (sale price)

![image](https://github.com/user-attachments/assets/84298b83-4e1d-4b00-9ea6-f148886b554d) Figure: A schematic presentation of the end-to-end ML pipeline
...
[View codes on GitHub](https://github.com/muntasirhsn/End-to-end-ML-pipeline/tree/main)
