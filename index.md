...
Automate end-to-end machine learning (ML) workflow for all the steps including data preprocessing, training models at scale with distributed computing (GPUs/CPUs), model evaluation, deploying in production, model monitoring and drift detection with Amazon SageMaker pipeline - a purpose-built CI/CD service.


<img src="images/MLOps6_Muntasir Hossain.jpg?raw=true"/> Figure 1: ML orchestration reference architecture with AWS

<img src="images/Sageaker Pipeline5.png?raw=true"/> Figure 2: CI/CD pipeline with Amazon Sagemaker 



<img src="images/RealtimeInference-Postman4.png?raw=true"/> Figure 3: Real-time inference with the ML model deployed in production. A REST API was created by using Amazon API Gateway as an external-facing entry point for the model endpoint. The API was tested with Postman (API platform) for real-time inference.
...
![image](https://github.com/muntasirhsn/muntasirhsn.github.io/assets/29087240/60e16b91-e03a-4d2a-9953-9d6b860fd76a) Figure 6: Transforming Skewed Features


<img src="images/Stacking Model.png?raw=true"/> Figure 7: A schematic presentation of the stacking ML model architecture
...
<img src="images/highway1-detect3.gif?raw=true"/> Figure 4: Object detection with YOLOv8 model deployed to a real-time Amazon SageMaker endpoint
...
<img src="images/time-series3.png?raw=true"/>  Figure 8: Actual and predicted energy usage over 12 weeks of time period
...
<img src="images/PostgreSQL2.png?raw=true"/> Figure 9: Transformed and loaded data in PostgreSQL database
